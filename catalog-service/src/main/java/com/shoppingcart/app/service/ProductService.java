...
public class ProductService {
	 ...
	 * productRepository.findByName(createdProduct.getName()); Product productByName
	 * = product.get(); if(productByName != null && productByName.getId() !=
	 * createdProduct.getId()) { throw new RuntimeException(
	 * String.format("The product %s is already registered",
	 * createdProduct.getName().toUpperCase())); } }
	 */
}
